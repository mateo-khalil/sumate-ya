...
INSERT INTO "clubs" ("id", "ownerId", "name", "address", "zone", "lat", "lng", "phone", "description") VALUES
  ...
  ('b1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000008', 'Cancha OK Belgrano','Av. Cabildo 2500, Belgrano', 'Norte', -34.5605, -58.4590, '+54 11 4777-3333', 'Cancha 5v5 indoor')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "courts" ("id", "clubId", "name", "surface", "isIndoor", "maxFormat") VALUES
  ...
  ('c1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000003', 'Indoor 1 (5v5)',   'indoor',    true,  '5v5')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "clubSlots" ("id", "clubId", "courtId", "dayOfWeek", "startTime", "endTime", "priceArs") VALUES
  ...
  ('d1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000006', 'saturday',  '10:00', '11:00', 28000)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "matches" ("id", "organizerId", "clubId", "courtId", "clubSlotId", "format", "capacity", "scheduledAt", "durationMin", "status", "description", "resultStatus", "winningTeam", "scoreTeamA", "scoreTeamB") VALUES
  ...
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000005', 'b1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000006', '5v5',   10, now() + interval '1 day',   60, 'full',      'Equipos ya armados',                  'pending',   NULL, NULL, NULL),
...
INSERT INTO "matchParticipants" ("matchId", "playerId", "team") VALUES
  ...
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000001', 'a'),
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002', 'a'),
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 'a'),
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000004', 'a'),
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000005', 'a'),
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000006', 'b'),
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000007', 'b'),
  ('e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000008', 'b'),
